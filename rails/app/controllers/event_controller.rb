class EventController < ApplicationController
  ...
  def save
    event = write_row( Event, params[:event], {:except=>[:event_id,:conference_id],:init=>{:event_id=>nil,:conference_id=>@current_conference.conference_id},:always=>[:public,:prerecorded,:physical,:virtual]} )
