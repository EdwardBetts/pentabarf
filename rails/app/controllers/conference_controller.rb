class ConferenceController < ApplicationController
  ...
  def save
    conf = write_row( Conference, params[:conference], {:except=>[:conference_id],:always=>[:f_submission_enabled,:f_submission_new_events,:f_submission_writable,:f_visitor_enabled,:f_travel_enabled,:f_feedback_enabled,:f_reconfirmation_enabled,:f_matrix_bot_enabled,:f_timeshift_test_enabled],:init=>{:conference_id=>nil}} )
    ...
    write_rows( Conference_track_room, params[:conference_track_room], {:preset=>{:conference_id => conf.conference_id},:ignore_empty=>:conference_track_id})
